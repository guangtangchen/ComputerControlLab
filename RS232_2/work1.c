//ICC-AVR application builder : 2008-5-9 9:30:58
// Target : M128
// Crystal: 16.000Mhz
...
//------------------------------------------------------------------------------  
void display(unsigned int num,unsigned int value)
{	
	char i;
	int nn;
	...
	for(i=1;i<5;i++)
	{
		...
		// i=4 --> number of sample
		// i<4 --> real sample data
		if(i<4)		  
		{
